...
<div>
<ul>
<li id="inputlabel"><label for="codeName">Name of Code Snippet:</label></li>
</ul>
</div>
<div>
<ul>
<li id="inputbox"><input type="text" name="codeName" id="inputbox" />
</li>
</ul>
</div>
...
<div>
<ul>
<li id="inputlabel"><label for="codeDescription">Enter a code snippet description:</label>
</ul>
</div>
<div>
<ul>
<li id="inputbox"><textarea rows="10" cols="50" name="codeDescription" id="inputbox" placeholder="Please enter a description here"></textarea>
</li>
</ul>
</div>
...
<div>
<ul>
<li id="inputlabel"><label for="codeSnippet">Enter code snippet:</label></li>
</ul>
</div>
<div>
<ul>
<li id="inputbox"><textarea rows="10" cols="30" name="codeSnippet" id="inputbox">
</textarea>
</li>
</ul>
</div>
...
<div>
<ul>
<li id="inputlabel"><label for="publicView">Make Public? </label></li>
</ul>
</div>
<div>
<ul>
<li id="inputbox"><input type="checkbox" name="publicView" value = "true" />
</li>
</ul>
</div>
...
<div>
<ul>
<li id="inputlabel"><label for="publicView">Attribution </label></li>
</ul>
</div>
<div>
<ul>
