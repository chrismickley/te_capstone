...
<p>Provide a repository of useful code snippets. There are many
	...
	wanted to create an app which is bare bones so when the user searches
	for a code snippet, they are provided with an example and not much
	else. The goal is to provide an example snippet and minimize
	distractions clutter found on most coding web pages.</p>
<h1>About The Designers</h1>

<p>Bruce Stull has had a strange path to the world of programming.
